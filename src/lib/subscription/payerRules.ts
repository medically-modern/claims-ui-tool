...
export const PAYER_GROUPS: readonly PayerGroup[] = [
  {
    ...
    name: "Medicaid",
    payers: ["Medicaid"],
    eligibility: { freshnessDays: 7, sameMonth: true, cobCheck: false, primaryMatch: false, hospiceOk: false },
    auth: "dvs",
  ...
  },
  {
    ...
    eligibility: { freshnessDays: 7, sameMonth: true, cobCheck: true, primaryMatch: true, hospiceOk: false },
...
export const RULES: readonly RuleDef[] = [
  ...
  },
  {
    ...
    verdict: "block",
    source: "Runbook step 5 (decided 2026-09-14); extended to every payer, 7 days and same month, 2026-09-21 (Brandon) — a check older than 7 days or from a prior month doesn't cover the order.",
  },
  {
